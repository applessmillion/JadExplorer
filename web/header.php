...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div id="navbarNavDropdown" class="navbar-collapse collapse">
        ...
        <ul class="navbar-nav">
			...
			if(isset($_COOKIE['shux_user'])){ ?>
				<li class="nav-item">
					<a class="nav-link" href="<?php echo $link_header_account; ?>"><b><?php echo $text_header_link_logged.$_COOKIE['shux_user']; ?></b></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?php echo $link_header_logout; ?>" onclick="doLoading()"><?php echo $text_header_link_logout; ?></a>
				</li>
			<?php }else{?>
				<li class="nav-item">
					<a class="nav-link" href="<?php echo $link_header_login; ?>" onclick="doLoading()"><?php echo $text_header_link_login; ?></a>
				</li>
			<?php } ?>
        </ul>
    </div>
